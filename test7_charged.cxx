// Run with:
// clas12root test7_charged.cxx
// If readfiles1 method provide a text file reader using Argc, Argv:
// clas12root test7_charged.cxx --in=input_filename.dat (or .txt)
...
int test7_charged(){
  ...
  for(int ifile=0; ifile<chain.GetNFiles(); ++ifile){
    ...
    while(c12.next()==true){
      ...
      //vector<region_part_ptr> parts=c12.getDetParticles();
      auto parts=c12.getDetParticles();
      ...
      //at this point, only events with two charged tracks,
      ...
      //at this point, only events where the second charged track has not
      //been explicitely identified as electron/positron, or proton, deuteron,
      //or PID=0, and is in sectors 3 and 5 region 2000. 
	...
	TFile* out = new TFile("out_charged.root","RECREATE");
